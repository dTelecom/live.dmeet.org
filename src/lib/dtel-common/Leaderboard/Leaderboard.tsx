...
const description = {
  title: "Use Livestreaming\nand Get Points",
  text: "We have launched a campaign for early adopters who use Livestreaming, create and participate in live broadcasts.",
  rules: {
    ...
    items: [
      {
        ...
        text2: "for hosting a livestream\n(with 1+ viewer required)"
      },
      {
        badge: "Viewer",
  ...
  footer: {
    ...
    text2: "We will 💎 reward active campaign participants for their commitment to Livestreaming."
  }
};
