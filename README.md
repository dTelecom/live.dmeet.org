...
Try it for free at https://live.dmeet.org

A free, open-source web app for livestreaming — join streams or start your own effortlessly.

## Deploying

This demo is a Next.js app. You can deploy to your Vercel account with one click:

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/dTelecom/live.dmeet.org&env=API_KEY,API_SECRET&envDescription=Sign%20up%20for%20an%20account%20at%20https://cloud.dtelecom.org%20and%20create%20an%20API%20key%20in%20the%20Project%20Settings%20UI)
...
```bash
git clone git@github.com:dTelecom/live.dmeet.org.git
cd live.dmeet.org
npm install
```
